...
try:
    for i in range(1, int(index) + 1):
        if os.path.exists(os.path.join(input_path, f'{i}else.mp4')):
            shutil.move(os.path.join(input_path, current_file), os.path.join(normal_path, f'{i}else.mp4'))
        elif os.path.exists(os.path.join(input_path, f'{i}voice.mp4')):
            shutil.move(os.path.join(input_path, current_file), os.path.join(normal_path, f'{i}voice.mp4'))
except FileNotFoundError:
    print(f"File not found")
