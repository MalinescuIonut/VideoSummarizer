...
::dir /s /b "E:\pendientes\%NAME%\VIDEO_TS\*.vob" >"E:\pendientes\%NAME%\listaVOB.lis"
::notepad "E:\pendientes\%NAME%\listaVOB.lis"
::pause
::"%FOLDERSW%\ffmpeg.exe" -analyzeduration 100M -probesize 100M -i "%NAME%.VOB"
::pause
::"%FOLDERSW%\ffmpeg.exe" -analyzeduration 100M -probesize 100M -i lista.VOB -map 0:1 -map 0:3 -map 0:4 -map 0:5 -map 0:6 -codec:v libx264 -crf 21 -codec:a libmp3lame -qscale:a 2 -codec:s copy "%NAME%.mkv"
::pause
::"%FOLDERSW%\ffmpeg.exe" -ss 00:00:03.000 -i "%FILE%" -to 00:33:34.000 -c copy v2-"%FILE%"
::pause
...
::call "%FOLDERSW%\bucle2summarize.bat" %NAME% %FOLDER% %FOLDER2% %FOLDER3% %USER% %THRESHOLD% %FOLDER0% %FOLDER4%
::call "%FOLDERSW%\bucle3summarize.bat" %NAME% %FOLDER% %FOLDER2% %FOLDER3% %USER% %THRESHOLD% %FOLDER0% %FOLDER4%
...
::"%FOLDERSW%\ffmpeg.exe" -i "%FILE%" -map "0:s:%TRACKSUBT%" -y "%NAME%ORIG.srt"
