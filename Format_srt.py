...
def fill_srt(file_name):
    ...
    with open("voice-else_subs.srt", 'w') as output:
        ...
        final_time_seconds = lastkeyframe
        last_time_seconds = last_end[0] * 3600 + last_end[1] * 60 + float(last_end[2])

        if last_end != final_time and last_time_seconds < final_time_seconds:
